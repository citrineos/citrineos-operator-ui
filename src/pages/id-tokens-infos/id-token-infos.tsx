...
import { ID_TOKEN_INFOS_CREATE_MUTATION, ID_TOKEN_INFOS_DELETE_MUTATION, ID_TOKEN_INFOS_EDIT_MUTATION, ID_TOKEN_INFOS_LIST_QUERY, ID_TOKEN_INFOS_SHOW_QUERY } from "./queries";
