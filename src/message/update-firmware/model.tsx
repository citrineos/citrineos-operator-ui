...
import { IsInt, IsNotEmpty, IsOptional, IsString, IsUrl, Length, Min, ValidateNested } from "class-validator";
...
export class FirmwareType {
    ...
    @CustomFormRender(() => {
      return (
        <Form.Item
          label={FirmwareTypeProps.location}
          name={[
            UpdateFirmwareRequestProps.firmware,
            FirmwareTypeProps.location,
          ]}
          rules={[
            {
              required: true,
