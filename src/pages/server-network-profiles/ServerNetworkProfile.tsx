...
import { SERVER_NETWORK_PROFILE_LIST_QUERY, SERVER_NETWORK_PROFILE_GET_QUERY, SERVER_NETWORK_PROFILE_CREATE_MUTATION, SERVER_NETWORK_PROFILE_EDIT_MUTATION, SERVER_NETWORK_PROFILE_DELETE_MUTATION } from './queries';
