...
import {GET_METER_VALUES_FOR_TRANSACTION_EVENT, METER_VALUE_LIST_QUERY} from "../queries";
import {MeterValueDto, MeterValueDtoProps} from "../../../dtos/meter.value.dto";
...
export const MeterValuesList = ({
  ...
  const { tableProps } = useTable<MeterValueDto>({
    ...
    sorters: { initial: [{ field: MeterValueDtoProps.timestamp, order: 'desc' }] },
    meta: {
